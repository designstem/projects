...
# Scenario #1: The Dice Cylinder

Dice games are board games played by dice. They are very popular especially among children.

![](https://spiralsdesignstem.files.wordpress.com/2019/05/eikona1.png?w=234&h=184)
...
![](https://spiralsdesignstem.files.wordpress.com/2019/05/eikona2.png?w=161&h=103)

Assume that you want to design an object that could help rolling the dice efficiently in a restricted space. Let such an object be a dice-cylinder, i.e. a cylinder that when the player lets the dice from the top, it will let them go down rolling and let them exit at the bottom level. A dice-cylinder should look like the following picture.

![](https://spiralsdesignstem.files.wordpress.com/2019/05/eikona9.png?w=107&h=164)

To solve such a problem, consider the spiral theory. The path that follows the dice down to the exit of the cylinder may be a helix tube or a round staircase.

> This scenario is aimed at 15-25 aged students to address the problem of designing a Dice Cylinder and implementing its construction by using 3D printing technology. This scenario integrates the knowledge of **S**cience (Physics, material strength), **T**echnology, **E**ngineering (use of a 3D printed object in mechanisms) and **M**athematics (use of trigonometric equations and polar coordinates.

---

# Scenario #2 : The clock spring

![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic1.jpg?w=156&h=131)

*Clock springs* are used in various applications in mechanical and electrical engineering.  ![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic22.jpg?w=146&h=109) They are also known as *power strings*.
...
![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic21.jpg?w=159&h=120)

> This scenario is aimed at 20-25 aged students to address the problem of designing a Clock Spring and implementing its construction by using 3D printing technology. This scenario integrates the knowledge of **S**cience (Physics, material strength), **T**echnology, **E**ngineering (use of a 3D printed object in mechanisms) and **M**athematics (use of trigonometric equations and polar coordinates.

---

# Scenario #3 : The Helical Compression Spring

Helical compression springs are used to have a resistance to applied axial compression forces or to store potential energy under compression loads.

![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic7.jpg?w=225&h=225)

In terms of energy storage per unit volume, they are among the most efficient spring type available. They are found in many real life applications such as automotive engines, valves, locomotives. While the most common used form of compression spring is a straight cylindrical spring made from round wire, many other shapes exist including conical, barrel and hourglass, with or without variable spacing between coils.

![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic6.jpg?w=185&h=214)
...
# Scenario #4 : The sheet metal screw

![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic82.jpg?w=225&h=225)
...
![](https://spiralsdesignstem.files.wordpress.com/2018/07/pic9.jpg?w=101&h=300)
...
> This scenario is aimed at 20-25 aged students to address the problem of designing a simple sheet metal screw and implementing its construction by using 3D printing technology. This scenario integrates the knowledge of **S**cience (Physics, material strength), **T**echnology, **E**ngineering (use of a 3D printed object in mechanisms) and **M**athematics (use of trigonometric equations and polar coordinates.
...
* 3D Printing of a **[Spiral Cube](https://youtu.be/pS2WOM_TBjs)**
* 3D Printing of a **[Tornado](https://youtu.be/FHV3Sn-KqlQ)**
* 3D Printing of a **[DNA chain – 1](https://youtu.be/HB7imT8L5x0)**
* 3D Printing of a **[DNA chain – 2](https://youtu.be/86W2zbpf4Io)**

*(The objects that were 3D Printed were retrieved from: https://www.youmagine.com/ and https://www.thingiverse.com/)*
...
[3D Design Software](https://spiralsdesignstem.wordpress.com/3d-design-software/)

[3D Design](https://spiralsdesignstem.wordpress.com/3d-design/)

[3D Printing](https://spiralsdesignstem.wordpress.com/3d-printing/)

[3D Printing Gallery](https://spiralsdesignstem.wordpress.com/3d-printing-gallery/)

(*Source: [https://en.wikipedia.org/wiki/3D\_modeling](https://en.wikipedia.org/wiki/3D_modeling)*)
