...
export default {
  ...
  <a-entity class="clock" :position="position" :rotation="rotation" :scale="scaleTheClock()" shadow="cast: false">
    ...
    <a-entity :rotation="sRot">
      <a-box material="color: red" position="0 .35 0" height=".8" width=".03" depth=".03"></a-box>
    </a-entity>
    <a-cylinder material="color: yellow" rotation="90 0 0" height=".1" position="0 0 -.1"></a-cylinder>
  </a-entity>
  `
};